                        ...
                        <div class="col-lg-6">
                            <div class="card card-warning card-outline">
                                <div class="card-header">
                                    <h5 class="m-0">Tambah Kriteria</h5>
                                </div>
                                <div class="card-body">
                                    <?php echo form_open("kriteria/tambah/"); ?>
                                    <div class="form-group">
                                        <label for="kd_kriteria">Kode Kriteria</label>
                                        <input type="text" class="form-control" name="kd_kriteria" id="kd_kriteria">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" step=".1" class="form-control" name="nilai" id="nilai">
                                    </div>
                                </div>
