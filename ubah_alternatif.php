...
<body class="hold-transition sidebar-mini sidebar-collapse pace-teal pace-theme-flash-teal">
    <div class="wrapper">
                                        ...
                                        <tbody>
                                            ...
                                            if (!empty($alternatif)) {
                                                ...
                                                foreach ($alternatif as $dataalternatif) {
                                                    ...
                                                    echo "<a href='" . base_url("alternatif/hapus/" . $dataalternatif['nama']) . "'>";
        ...
        <!-- Control Sidebar -->
        <div class="modal fade" id="modal-ubah-alternatif">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <?php
                    echo form_open("alternatif/ubah/".$selectedAlternatif->kd_alternatif); ?>
                    <div class="modal-body">
                    <input type="text" class="form-control" name="id_temp" placeholder="Masukkan kode alternatif..." required value="<?= $selectedAlternatif->kd_alternatif ?>" hidden>
                        <div class="form-group">
                            <label for="kd_alternatif">Kode Alternatif*</label>
                            <input type="text" class="form-control" name="kd_alternatif" placeholder="Masukkan kode alternatif..." required value="<?= $selectedAlternatif->kd_alternatif ?>">
                        </div>
                        <div class="form-group">
                            <label for="nama_alternatif">Nama Alternatif</label>
                            <input type="text" class="form-control" name="nama_alternatif" placeholder="Masukkan nama alternatif..." value="<?= $selectedAlternatif->nama ?>" required>
                        </div>
                        ...
                        foreach ($kriteria as $datakriteria) { ?>
                            <div class="form-group">
                                <label for="<?= $datakriteria['kd_kriteria'] ?>"><?= $datakriteria['keterangan'] ?></label>
                                <input type="number" step=".1" class="form-control" name="<?= $datakriteria['kd_kriteria'] ?>" placeholder="Masukkan nilai <?= $datakriteria['keterangan'] ?>..." <?php
                                                                                                                                                                                                    foreach ($nilaiAlternatif as $nilai) {
                                                                                                                                                                                                        if ($nilai['kd_kriteria'] == $datakriteria['kd_kriteria']) {
    ...
    <script>
        ...
        $(window).on('load', function() {
            $('#modal-ubah-alternatif').modal('show');
        });
    </script>
